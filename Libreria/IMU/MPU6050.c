 ...
 *
  ...
  *  ------------------------------------------------------------------------- 
* Created: Wed May 21 16:55:32 2014
*/
...
#define SOURCEFILES "__SFB__INC_PATH C:\MATLAB\SupportPackages\R2014a\arduino-1.0.5\libraries"
#define PANELINDEX           6
...
extern void MPU6050_Outputs_wrapper(real_T *acc_X,
			real_T *acc_Y,
			real_T *acc_Z,
			real_T *gyro_X,
			real_T *gyro_Y,
			real_T *gyro_Z,
			const real_T *xD);
extern void MPU6050_Update_wrapper(const real_T *acc_X,
			const real_T *acc_Y,
			const real_T *acc_Z,
			const real_T *gyro_X,
			const real_T *gyro_Y,
...
{
    real_T        *acc_X  = (real_T *)ssGetOutputPortRealSignal(S,0);
    real_T        *acc_Y  = (real_T *)ssGetOutputPortRealSignal(S,1);
    real_T        *acc_Z  = (real_T *)ssGetOutputPortRealSignal(S,2);
    real_T        *gyro_X  = (real_T *)ssGetOutputPortRealSignal(S,3);
    real_T        *gyro_Y  = (real_T *)ssGetOutputPortRealSignal(S,4);
    real_T        *gyro_Z  = (real_T *)ssGetOutputPortRealSignal(S,5);
    const real_T   *xD = ssGetDiscStates(S);


    MPU6050_Outputs_wrapper(acc_X, acc_Y, acc_Z, gyro_X, gyro_Y, gyro_Z, xD);
...
/* Function: mdlUpdate ======================================================
  ...
  static void mdlUpdate(SimStruct *S, int_T tid)
  {
    ...
    MPU6050_Update_wrapper(acc_X, acc_Y, acc_Z, gyro_X, gyro_Y, gyro_Z,  xD);
}
